                ...
                <div className="container mx-auto px-4 py-20">
                    <div className="flex flex-col md:flex-row items-center">
                        <div className="md:w-1/2 mb-10 md:mb-0 relative">
                            ...
                            <Link
                                to="/mugs"
                                className="bg-pink-500 text-white px-8 py-3 rounded-full flex items-center hover:bg-pink-600 transition-all hover:transform hover:scale-105 hover:shadow-lg inline-flex"
                            >
                                Shop Now <ChevronRight className="ml-2" />
                            </Link>
                        </div>
                        <div className="md:w-1/2">
                            <div className="p-3 bg-gradient-to-r from-pink-200 via-pink-300 to-pink-200 rounded-[2rem] shadow-xl">
                                <img
                                    src={home_mug}
                                    alt="Beautiful Ceramic Mug"
                                    className="rounded-[1.5rem] shadow-inner w-full h-full object-cover floating-image"
                                />
                            </div>
                        </div>
                    </div>
